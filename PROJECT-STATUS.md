...
| P3-A01 | Continuous Annotation Pipeline | feat/P3-A01 | Hard-example mining from TimescaleDB + debug traces, automated CVAT hard-example task creation with seeded predictions, annotation feedback export, and a daily mining cron/systemd artifact |

### Phase 3 — Pending (7 tasks remaining)
